...
public class Cau5 {
    ...
    public static void standardizeString(){
        ...
        String result = ""; // tạo biến result
        for(int i = 0; i < arr.length; i++){
            String firstChar = String.valueOf(arr[i].charAt(0)).toUpperCase(); // Viết in hoa ký tự đầu tiên, String.valueOf(): ép kiểu thành chuỗi để sử dụng phương thức toUpperCase()
